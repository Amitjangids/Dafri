...
class updateOzowStatus extends Command {
    ...
    public function handle(Request $request) {
        ...
        $transactions = Transaction::where('trans_for', 'OZOW_EFT')->where('status', '2')->where('created_at', '>=', '2022-05-20')->get();
...
//                                echo '<pre>';print_r($convertedCurrArr);exit;
                        ...
                        Transaction::where("id", $transID)->update(['fees' => $fee_amount, 'cron_update' => 1,'refrence_id' => $refID, 'billing_description' => $billingDesc, 'status' => 3, 'updated_at' => date('Y-m-d H:i:s')]);
...
//                                echo '<pre>';print_r($convertedCurrArr);exit;
                        ...
                        Transaction::where("id", $transID)->update(['fees' => $fee_amount, 'cron_update' => 1,'refrence_id' => $refID, 'billing_description' => $billingDesc, 'status' => 5, 'updated_at' => date('Y-m-d H:i:s')]);
...
//                                echo '<pre>';print_r($convertedCurrArr);exit;
                        ...
                        Transaction::where("id", $transID)->update(['fees' => $fee_amount, 'cron_update' => 1,'refrence_id' => $refID, 'billing_description' => $billingDesc, 'status' => 6, 'updated_at' => date('Y-m-d H:i:s')]);
...
//                    return Redirect::to('auth/add-fund');
                        ...
                        Transaction::where("id", $transID)->update(['refrence_id' => $refID, 'cron_update' => 1,'billing_description' => $billingDesc, 'status' => 7, 'updated_at' => date('Y-m-d H:i:s')]);
