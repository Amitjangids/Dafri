...
class updateOzowStatus extends Command {
    ...
    public function handle(Request $request) {
        ...
        $transactions = Transaction::where('trans_for', 'OZOW_EFT')->where('status', '2')->where('id',558)->get();
...
//                exit;
                    ...
                    Transaction::where("id", $transID)->update(['fees' => $fee_amount, 'refrence_id' => $refID, 'billing_description' => $billingDesc, 'status' => 1, 'updated_at' => date('Y-m-d H:i:s')]);
