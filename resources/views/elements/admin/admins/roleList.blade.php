            ...
            <table class="table table-bordered table-striped table-condensed cf">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:55%" data-title="Permission">{{$permissions}}</td>
                        ...
                        <td style="width:5%" data-title="Action">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="{{ URL::to( 'admin/admins/edit-role/'.$role->id)}}" title="Edit Role" class=""><i class="fa fa-pencil"></i>Edit Role</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
