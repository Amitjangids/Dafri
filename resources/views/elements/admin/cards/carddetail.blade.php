            ...
            <table class="table table-bordered table-striped table-condensed cf">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Company Name">{{$allrecord->serial_number}}</td>
                        <td data-title="Company Name">{{$allrecord->pin_number}}</td>
                        <td data-title="Company Name">{{CURR}} {{$allrecord->card_value}}</td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status{{$allrecord->id}}">
                                        @if($allrecord->status == '1')
                                        <a href="{{ URL::to( 'admin/cards/deactivate/'.$allrecord->id)}}" title="Deactivate" class="deactivate"><i class="fa fa-check"></i>Deactivate Card</a>
                                        @else
                                        <a href="{{ URL::to( 'admin/cards/activate/'.$allrecord->id)}}" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate User</a>
                                        @endif
                                    </li>
