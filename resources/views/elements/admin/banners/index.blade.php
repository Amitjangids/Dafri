            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging">@sortablelink('banner_link', 'Banner Link')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Banner Link">{{$allrecord->banner_link}}</td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="right_acdc" id="status{{$allrecord->id}}">
                                        ...
                                        @else
                                        <a href="{{ URL::to( 'admin/banners/activate/'.$allrecord->slug)}}" title="Activate" class="activate"><i class="fa fa-ban"></i>Activate User</a>
                                        @endif
                                    </li>
    ...
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            ...
            <div class="drt">
                ...
                <div class="admin_pop"><span>Banner Link: </span>  <label>{!! $allrecord->banner_link !!}</label></div>
