...
<div class="panel-body marginzero">
    ...
    <section id="no-more-tables" class="lstng-section">
        <div class="topn">
            <div class="topn_left">Crypto Withdraw Request's List</div>
            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th width="20%" class="sorting_paging">@sortablelink('payout_addrs', 'Payout Address')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td data-title="Ticket ID"><a href="#sss-{!! $allrecord->id !!}" title="View Request Detail" class="" rel='facebox'>{{strtoupper($allrecord->user_name)}}</a></td>
						<td data-title="Support Type">{{$allrecord->amount}}</td>
                        <td data-title="Request Text">{{$allrecord->crypto_currency}}</td>
                        <td data-title="First name"><a href="{{$allrecord->payout_addrs}}" target="_blank">{{$allrecord->payout_addrs}}</a><a onclick="copyTextToClipboard('{{$allrecord->payout_addrs}}');" href="#" class="copy-icon" >{{HTML::image('public/img/front/copy-icon.svg', SITE_TITLE ,array('style' => 'width:15px'))}}</a></td>
                        ...
                        <td data-title="Action">
                            ...
                            <div class="btn-group">
								...
								<!-- <li><a href="{{URL::to('admin/users/edit-crypto-withdraw-request/'.$allrecord->id.'/')}}" title="Edit Request" class=""><i class="fa fa-edit"></i>Edit</a></li> -->
								...
								<li><a href="{{URL::to('admin/users/change-crypto-withdraw-req-status/'.$allrecord->id.'/2')}}"  title="Change request status to Hold" class=""><i class="fa fa-clock-o"></i>Hold</a></li>
    ...
    <div class="modal-dialog md1">
        <div class="modal-content transfer-pop">
            <div class="transfer-fund-pop">
                ...
                <div class="filed-box">
                    <div class="form-control-new w100">
                        <label>Amount</label>
                        <input type="text" value="{!! $allrecord->crypto_currency.' '.$allrecord->amount !!}" id="recipEmail" placeholder="" disabled>
                    </div>
                    <div class="form-control-new w100">
                        <label>Blockchain URL</label>
                        <input type="text" value="{{$allrecord->payout_addrs}}" id="recipAmountTF" placeholder="" disabled>
                    </div>   
            ...
            <div class="modal-footer pop-ok">
                <a href="{{URL::to('admin/users/change-crypto-withdraw-req-status/'.$allrecord->id.'/1')}}" type="button" class="btn btn-default button_disable{{$allrecord->id}}" onclick="disable_submit_{{$allrecord->id}}()" >Confirm</a>
...
<div class="modal fade" id="basicModal_reject{{$allrecord->id}}" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog md1">
        <div class="modal-content transfer-pop">
            ...
            <div class="modal-footer pop-ok">
                <a href="{{URL::to('admin/users/change-crypto-withdraw-req-status/'.$allrecord->id.'/3')}}" type="button" class="btn btn-default button_disable{{$allrecord->id}}" onclick="disable_submit_{{$allrecord->id}}()" >Confirm</a>
                <button type="button" class="btn btn-default bg-btn" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
