...
<div class="panel-body marginzero" style="padding-bottom: 100px">
    ...
    <section id="no-more-tables" class="lstng-section">
        <div class="topn">
            <div class="topn_left">Affiliated Accounts List</div>
        ...
        <div class="tbl-resp-listing">
            <table class="table table-bordered table-striped table-condensed cf">
                ...
                <tbody>
                    ...
                    @php
$userTyp = getUserType($allrecord->id);
if ($userTyp == false)
{
continue;	 
}
@endphp
                    <tr>
                    <td data-title="Name">{{ $number }}</td>
                        <td data-title="Name"><a href="#info{!! $allrecord->id !!}" title="View User Detail" class="" rel='facebox'>@if($userTyp == 'Personal')
                                {{isset($allrecord->first_name) ? strtoupper(strtolower($allrecord->first_name)).' '.strtoupper(strtolower($allrecord->last_name)):'N/A'}}
                                @elseif($userTyp == 'Business')
                                {{ strtoupper($allrecord->business_name) }}
                                @elseif($userTyp == 'Agent')
                                {{isset($allrecord->first_name) ? strtoupper(strtolower($allrecord->first_name)).' '.strtoupper(strtolower($allrecord->last_name)):strtoupper($allrecord->business_name)}}
                                @endif</a></td>
...
@if(($allrecord->user_type=="Personal" || $allrecord->user_type=="Agent") && $allrecord->first_name!="")
