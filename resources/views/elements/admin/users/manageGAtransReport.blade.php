                    ...
                    <tr>
                       ...
                       <?php  }  ?>
                        ...
                        <td data-title="KYC Status">
                            ...
                            Received 
                            @else
                            @if($allrecord->trans_for=='Withdraw##Agent(Refund)')
                            Withdraw Agent(Refund)
        ...
        <div class="modal-content transfer-pop">
            <div class="transfer-fund-pop">
                ...
                <div class="filed-box">
                    <div class="form-control-new w100">
                        <label>Bank Name</label>
                        <input type="text" value="{!! $account->bank_name  !!}" id="recipEmail" pl aceholder="" disabled>
                    </div>
                ...
                <div class="filed-box" id="cuncyConvrsnTF">
                    <div class="form-control-new w100">
                        <label>Amount</label>
                        <input type="text" value="{!! $manual_withdraws_all->amount !!}" id="recipEmail" placeholder="" disabled>
                    </div>
                    <div class="form-control-new w100">
                        <label>Date</label>
                        <input type="text" value="{{$manual_withdraws_all->created_at}}" id="recipAmountTF" placeholder="" disabled>
                    </div>  
