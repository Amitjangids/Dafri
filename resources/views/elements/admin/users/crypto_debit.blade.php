...
<div class="panel-body marginzero" style="padding-bottom: 100px">
    ...
    <section id="no-more-tables" class="lstng-section">
        <div class="topn">
            <div class="topn_left">Crypto Deposit Currency List</div>
            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging">@sortablelink('address', 'Deposit Address')</th>
                ...
                <tbody>
                    ...
                    <span class="caret"></span>
                         ...
                         <li><a href="{{ URL::to( 'admin/users/crypto_currency_delete/'.$allrecord->id)}}" title="Delete" class="" onclick="javascript:return confirm('Are you sure you want to delete this currency ?');" ><i class="fa fa-trash"></i>Delete</a></li>
                          </ul>
                    </div>
                    </td>
                    </tr>
