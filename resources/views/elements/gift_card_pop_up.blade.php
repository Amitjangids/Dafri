        ...
        <style type="text/css">
            ...
            .website-modal button.close {position: absolute;top: 0;right: 0; min-width: 40px; min-height: 40px; width: 40px;height: 40px;border-radius: 50%;background: #e9b30b;opacity: 1;color: #fff;font-size: 28px;display: flex;z-index: 99;align-items: center;justify-content: center;}
            ...
            @media only screen and (max-width: 767px) {
                ...
                .website-modal .modal-dialog{padding: 20px;}
            ...
            @media screen and (max-width: 767px) and (orientation: landscape){
                .website-modal .modal-dialog {max-width: 430px;}
                .giftcard-modal-content h2 {font-size: 20px;}
                .giftcard-modal-content p {font-size: 14px;max-width: 210px;margin-bottom: 5px;}
            }
