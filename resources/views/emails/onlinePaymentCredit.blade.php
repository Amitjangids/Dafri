...
<tr>
    <td align="center" style="padding: 0 0 20px; display: block; width: 100%">
        <h1 style="font-size: 25px; margin-bottom: 0; font-weight: 300;">Hello, {{strtoupper($receiverName)}}</h1>
        <h6 style="padding:3px 0px; font-size:14px;display: block; text-align: center; color:#727379; line-height: 20px">A payment from {{strtoupper($payeeName)}} was successful..</h6>
    </td>
    ...
    <td style="width: 100%; display: block; padding: 0 40px; box-sizing: border-box;">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="right" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">{{$receiver_currency}} {{$fees_amount_receiver}}</td>
            </tr>
            <tr>
