...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            Congratulations, your manual deposit request with transaction ID {{$TransId}} has been processed successfully. Your amount ({{$currency}}  {{$amount}}). has been credited to your DafriBank account.
        </p>
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379;line-height: 20px "> 
