...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">Your account has been credited with ' . $transCurrency . ' ' . $transAmnt . ' and fees for this transaction is ' . $fee_amount . '. The transaction ID is ' . $transID . ' and reference ID is ' . $refID . '.</p>
