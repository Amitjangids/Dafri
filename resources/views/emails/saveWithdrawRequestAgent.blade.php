...
<tr>
    <td>
       <h4 style="padding:0px 0px 0px 0px; font-size:16px; text-align: left;display: block; color:#242528;"><span>Dear </span> {{strtoupper($agentname)}},</h4>

        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379;line-height: 20px ">
           You have a pending withdrawal request for {{$amount}}  from {{$userName}}.
        </p>
       <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379;line-height: 20px ">
           Please login to your bank agent account to accept or decline the transaction. 
       </p>
       <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379;line-height: 20px ">
          Payout Instructions : {{$remarkMsg}}.
       </p>
