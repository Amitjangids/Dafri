...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            A withdrawal request from {{$user_name}} for an amount of {{$amount}} with a transaction ID {{$TransId}} was received. 
        </p>
        
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            To accept this request, please login to your DafriBank online banking and navigate to Client Withdrawal to proceed.
        </p>
