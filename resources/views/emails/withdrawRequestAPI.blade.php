...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            ...
            Your withdrawal request for {{$withdrawAmount}} has been accepted by {{strtoupper($agentName)}}. Please contact your merchant for further inquiry.
        </p>
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379;line-height: 20px ">  If this action wasn't done by you please contact us immediately.
        </p>
