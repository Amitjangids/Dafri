...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
           Your global / 3rd party pay withdrawal request for {{$currency }} {{$amount }} with transaction ID {{$TransId}}  was declined by finance department. For more info Please contact us for further inquiry.
        </p>
