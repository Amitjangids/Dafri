...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            Congratulations, your Crypto Currency deposit request with transaction ID {{$TransId}} has been processed successfully and {{$amount_cc}} has been credited to your DafriBank account.
        </p>
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379;line-height: 20px ">         
