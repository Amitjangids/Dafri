...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            Congratulations, your Crypto Currency withdrawal request with transaction ID {{$TransId}} has been processed successfully. Your Crypto Currency {{$crypto_currency}} has been credited to your Trust Wallet account.
        </p>
