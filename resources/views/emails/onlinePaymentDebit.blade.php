...
<tr>
    <td align="center" style="padding: 0 0 20px; display: block; width: 100%">
        <h1 style="font-size: 25px; margin-bottom: 0; font-weight: 300;">Hello, {{ strtoupper($payeeName) }}</h1>
        <h6 style="padding:3px 0px; font-size:14px;display: block; text-align: center; color:#727379; line-height: 20px">A payment to {{strtoupper($receiverName)}} was successful..</h6>
    </td>
    <td align="center" style="display: block; width: 100%; padding-bottom: 36px;"><span  style="display: inline-block; font-size: 33px;border-radius: 20px;padding: 15px 39px; font-weight: 700; color: #fff; background: #000;box-shadow: 8px 8px 0 rgba(0,0,0,0.1);">{{$currency}} {{$mailAmount}}</span></td>
</tr>
<tr>
...
<tr>
    <td style="width: 100%; display: block; padding: 0 40px; box-sizing: border-box;">
        ...
        <table width="100%">
            <tr>
                <td align="left" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">Amount Paid</td>
                <td align="right" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">{{$currency}} {{$mailAmount}}</td>
            </tr>
            <tr>
                <td align="left" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">Transaction Fees</td>
                <td align="right" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">{{$sender_currency}} {{$fees_amount}}</td>
            </tr>
            <tr>
                <td align="left" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">Payment Method</td>
                <td align="right" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">Online Purchase</td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">Payment Reference</td>
                <td align="right" style="padding: 15px 0;border-bottom: 1px solid #C7C7C7 ">{{$refrence_id}}</td>
            </tr>
        </table>
    </td>
</tr>
