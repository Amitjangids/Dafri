<table width="710" align="center" style="table-layout:fixed; font-family:Arial, Helvetica, sans-serif; border:1px solid #537286; box-shadow: 0 0 5px #537286; padding:10px 15px;">
    <tbody><tr>
            <td valign="top" style=" background-color: #f4eff7;">
                <table width="100%">
                    <tbody><tr>
                            <td>
                                <a href="{{HTTP_PATH}}">
                                    {{HTML::image(LOGO_PATH_PNG, SITE_TITLE)}}
                                </a>
                            </td>
                        </tr>
                    </tbody>
        ...
        <!-- <tr>
            <td valign="top">
                ...
                <table width="100%" style="border-top:1px solid #ddd; background-color:#f4eff7; color: #000;">
                    <tbody><tr>
                            ...
                            <td align="right">
                                <a href="{{HTTP_PATH}}">{{HTML::image(LOGO_PATH_PNG, SITE_TITLE)}}</a>
                            </td>
                        </tr>
                    </tbody></table>
