...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">Congratulations, your paypal request with transaction ID  {{$TransId}} has been processed successfully. Your amount {{$currency }} {{$amount}} has been credited to your paypal account.</p>
