...
<tr>
    <td align="center" style="padding: 0 0 20px; display: block; width: 100%">
        ...
        <h6 style="padding:3px 0px; font-size:14px;display: block; text-align: center; color:#727379; line-height: 20px">A Card Deposit Request of {{$currency}} {{$amount}} has been successful.</h6>
    </td>
