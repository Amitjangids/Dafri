...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">Unfortunately, your paypal request with transaction ID {{$TransId}} has been cancelled. Your amount {{$currency }} {{$amount}} has been refunded to your account.</p>
