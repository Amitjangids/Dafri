...
<tr>
    <td>
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            An account with email address {{$invite_email}} is not opened within last one month. 
        </p>
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: left; color:#727379; line-height: 20px">
            Your amount {{$amount}} of transaction ID {{$transaction_id}} has been refunded to your account.
        </p>
