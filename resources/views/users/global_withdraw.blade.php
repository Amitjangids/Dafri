                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-field">
                                ...
                                <div class="field-box">
                                    <input name="cotb" class="required" placeholder="Enter Country of The Bank"  type="text">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-field">
                                ...
                                <div class="field-box">
                                    <input name="swc" class="required" placeholder="Enter Swift Code" type="text">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-field">
                                <label class="brcname">
                                  Branch Code/Routing/Sortcode
                                </label>
                                <div class="field-box">
                                    <input name="brnchCod" id="brnchCod" class="required" placeholder="Branch Code/Routing/Sortcode" type="text">
                                </div>
                            </div>
                        </div>
