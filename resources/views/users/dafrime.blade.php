                ...
                <div class="table-box col-sm-12">
                    <div class="ref-link">
                        <div class="ref-link-box">
                            <h6>My Payments links</h6>
                            <span>
                            <p>Use DafriBank™ ePayMe link to accept Visa/MasterCard, ePay, American Express, Apple Pay and Google Pay</p>
                            </span>
                        </div>
                        <a href="{{URL::to('auth/generate-payment-link')}}">Generate link</a>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td>{{$res->currency}} {{$refcode->amount}}</td>
                                    <td>{{HTTP_PATH}}/payment/{{$refcode->slug}}</a></td>
                                    <td>
                                    <a href="javascript:void(0);" class="cp-link" onclick="copyTextToClipboard('{{HTTP_PATH}}/payment/{{$refcode->slug}}');">Copy</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
