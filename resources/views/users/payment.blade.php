...
<style>
    ...
    @media (max-width: 767px){
        ...
        .payment-content-parent h3{line-height: 1.2;}
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-inner-parent">
                    <h2>Pay With</h2>
                    <form action="{{HTTP_PATH}}/epayme_form" method="post" onsubmit="return submit_form(this);">
                        <div class="custom_radio">
                            <div class="custom-wrapper-box">
                              ...
                              <label for="featured-1">
                                ...
                                <input type="hidden" name="order_amount" value="{{$payment_link->amount}}">
