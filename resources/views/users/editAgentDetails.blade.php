        ...
        <div class="wrapper2">
            <div class="row">
                ...
                <div class="drop-text-field col-sm-6 bcem-pay">
                    ...
                    {{Form::text('first_name', $agent->first_name, ['class'=>'required', 'placeholder'=>'Enter First Name', 'id'=> 'fname', 'autocomplete'=>'OFF'])}}
                    @else
                    {{Form::text('first_name', $agent->first_name, ['class'=>'required', 'placeholder'=>'Enter First Name', 'id'=> 'fname', 'autocomplete'=>'OFF'])}}
                    @endif
                </div>
                <div class="drop-text-field col-sm-6 bcem-pay">
                    <label>Surname</label>
                    @if($recordInfo->user_type == 'Personal')
                    {{Form::text('last_name', $agent->last_name, ['class'=>'required', 'placeholder'=>'Enter Last Name', 'id'=> 'lname', 'autocomplete'=>'OFF'])}}
                    @else
                    {{Form::text('last_name', $agent->last_name, ['class'=>'required', 'placeholder'=>'Enter Last Name', 'id'=> 'lname', 'autocomplete'=>'OFF'])}}
                    @endif
                </div>
                ...
                <div class="drop-text-field col-sm-6 bcem-pay">
                    ...
                    {{Form::text('commission', $agent->commission, ['class'=>'required', 'placeholder'=>'Commission Rates %', 'id'=> 'commission', 'autocomplete'=>'OFF','onkeypress'=>'return validateFloatKeyPress(this,event);'])}}
                </div>
                <div class="drop-text-field col-sm-6 bcem-pay">
                    <label>Minimum Deposit/Withdrawal</label>
                    {{Form::text('min_amount', $agent->min_amount, ['class'=>'required', 'placeholder'=>'Minimum Deposit/Withdrawal', 'id'=> 'min_deposit', 'autocomplete'=>'OFF', 'onkeypress'=>'return validateFloatKeyPress(this,event);'])}}
                </div>
                <div class="drop-text-field col-sm-6 bcem-pay">
                    <label>Physical Address</label>
                    {{Form::text('address', $agent->address , ['class'=>'required', 'placeholder'=>'Physical Address', 'id'=> 'address', 'autocomplete'=>'OFF'])}}
                </div>
                <div class="drop-text-field col-sm-6 bcem-pay">
                    <label>Telephone</label>
                    {{Form::text('phone', $agent->phone, ['class'=>'required', 'placeholder'=>'Telephone', 'id'=> 'phone', 'autocomplete'=>'OFF'])}}
                </div>
                <div class="drop-text-field col-sm-6 bcem-pay">
                    <label>Payment Methods Supported </label>
                    {{Form::text('payment_methods', $agent->payment_methods, ['class'=>'required','placeholder'=>'Payment Methods Supported', 'id'=> 'payment_method', 'autocomplete'=>'OFF'])}}
                </div>
                <div class="drop-text-field col-sm-6 bcem-pay">
                    <label>Email</label>
                ...
                <div class="file-container col-sm-6 upload-profile">
                    <div class="file-uploader pic-upload">
                        ...
                        {{Form::file('profile_image', ['class'=>'form-control', 'onchange'=>"readURL(this);",'id'=>"file-input", 'accept'=>"image/gif, image/jpeg, image/png"])}}
                     {{--   <input id="file-input" name="profile_image" type="file" onchange="readURL(this);" accept="image/gif, image/jpeg, image/png"> --}}
                    </div>
                ...
                <div class="drop-text-field col-sm-12 bcem-pay">
                    ...
                    {{Form::textarea('description', $agent->description, ['class'=>'required', 'placeholder'=>'Description', 'id'=> 'desc', 'autocomplete'=>'OFF'])}}
                </div>
