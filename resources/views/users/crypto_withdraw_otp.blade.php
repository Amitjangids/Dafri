...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="wrapper2">
            <div class="row">
                {{ Form::open(array('method' => 'post', 'id' => 'depstCrypto', 'class' => 'withdraw-form','onsubmit'=>'return disable_submit();','url'=>'auth/crypto-withdraw')) }}
                <div class="col-sm-6 border-right mob-big">
                    ...
                    <div class="deposit-amt">
                        <div class="heading-section">
                            <h5>Selected Crypto_options</h5>
                        </div>
                        <div class="">
                        <div class="drop-text-field">
                        <div class="depo-am">
                         {{Session::get('select_crypto_options')}}
                        </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="method-box mb-box">
                    ...
                    <div class="form-group form-field ">
                        ...
                        <div class="field-box otp-textbox">
                            <input name="otp_verify" id="otp_verify" class="required" placeholder="Enter OTP" type="text" autocomplete="off">
                        </div>
...
function disable_submit()
    ...
    $.ajax({
    url: "<?php echo HTTP_PATH; ?>/auth/resentOtpCrypto",
    type: "POST",
