            ...
            <div class="row">
                ...
                <div class="col-sm-6 border-right mob-big">
                    ...
                    <div class="deposit-amt">
                        ...
                        <div class="depo-am">
                            {{$recordInfo->currency.' '.base64_decode(Session::get('withdrawAmntMW64'))}}
                        </div>
                    </div>
                </div>
                @if (Session::get('show_otp_screen') != 'yes')
                <div class="method-box mb-box">
                    ...
                    <div class="add-new">
                        <a href="#" data-toggle="modal" data-target="#basicModal"><span>+</span> Add New Account</a>
                    </div>
