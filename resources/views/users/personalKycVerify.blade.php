...
<!--                            <div class="file-container doc-block" id="back_image_dv" style="display:none;">
                                <div class="file-uploader">
                        ...
                        <div class="form-group col-sm-6 ">
                            ...
                            <div class="doc-block ">
                                <div class="selectdiv">
                                    ...
                                    {{Form::select('address_proof_type', $addressType,null, ['id' => 'address_proof_type','placeholder' => 'Select document type'])}}
                                </div>
                            </div>
                            <br>
                             <div class="form-group doc-block">
...
function showFilename() {
    ...
    if(name.files.item(0).name!="")
    {
       ...
       {
           $('#identity_card').attr('required',true);
       }
    }
}
...
function showFilename2() {
    ...
    if(name.files.item(0).name!="")
    {
       ...
       if(address_proof_type=="" && name.files.item(0).name!="")
       {
           $('#address_proof_type').attr('required',true);
       }
    }
}
