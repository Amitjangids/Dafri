...
{{ Form::open(array('method' => 'post', 'name' =>'clntWithDrawForm', 'id' => 'clntWithDrawForm', 'class' => '','[formGroup]'=>'formGroup')) }}
...
<button class="sub-btn" id="agntWithdrawButn" onclick="covertCurrency();" type="button">Withdraw</button>
</div>
{{ Form::close() }}
</div>
