...
<tr>
    <td align="center" style="padding: 0 0 20px; display: block; width: 100%">
        ...
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: center; color:#727379; line-height: 20px">A payment to {{strtoupper($receiverName)}} was successful.</p>
    </td>
