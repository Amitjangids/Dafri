...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-info">
            ...
            {{Form::model($recordInfo, ['method' => 'post', 'id' => 'edtBlogForm', 'enctype' => "multipart/form-data"]) }}
            <div class="form-horizontal">
                <div class="box-body">
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label">Present Blog Image <span class="require">*</span></label>
                        <div class="col-sm-10">
                        {{HTML::image(BLOG_FULL_DISPLAY_PATH.$recordInfo->image, SITE_TITLE)}}
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-2 control-label">Blog Read Time <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::text('read_time', null, ['class'=>'form-control required', 'placeholder'=>'Blog Read Time', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
