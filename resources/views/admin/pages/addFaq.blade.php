...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-info">
            ...
            {{ Form::open(array('method' => 'post', 'id' => 'addFaqForm', 'enctype' => "multipart/form-data")) }}
            <div class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Question <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::textarea('ques', null, ['class'=>'form-control required', 'placeholder'=>'Question', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Answer <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::textarea('ans', null, ['class'=>'form-control required', 'placeholder'=>'Answer', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
					<div class="form-group">
