...
<!--					<div class="form-group">
		...
		<span id="phMinLngthErr"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('registration_number', $recordInfo->registration_number, ['class'=>'form-control ', 'placeholder'=>'Business registration number', 'autocomplete' => 'off', 'minlength' => 8, 'maxlength' => 16])}}
                        </div>
                    </div>  
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('national_identity_number', $recordInfo->national_identity_number, ['class'=>'form-control', 'placeholder'=>'Enter Document Number (if applicable)', 'autocomplete' => 'off', 'minlength' => 8, 'maxlength' => 16])}}
                        </div>
                    </div>  
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Enter Document Number (if applicable) <span class="require"></span></label>
                        <div class="col-sm-10">
                            {{Form::text('address_proof_number', $recordInfo->address_proof_number, ['class'=>'form-control', 'placeholder'=>'Enter Document Number (if applicable)', 'autocomplete' => 'off', 'minlength' => 8, 'maxlength' => 16])}}
                        </div>
                    </div>  
                    <div class="form-group">
