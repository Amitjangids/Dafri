...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Edit DBA Deposit by Card Request</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="{{URL::to('admin/users/crypto-deposit-request')}}"><i class="fa fa-user"></i> <span>DBA Deposit Request</span></a></li>
            <li class="active"> Edit DBA Deposit by Card</li>
        </ol>
    </section>
        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <?php 
                             if($req->req_type==0)
                             {
                             $currencyList = array('DBA BEP20'=>'DBA BEP20','DBA ERC20'=>'DBA ERC20');?>
                            {{Form::select('crypto_currency', $currencyList,null, ['class' => 'form-control required','placeholder' => 'Select Currency'])}}
                            <?php }else {  
                            ?>
                             {{Form::text('crypto_currency',$req->req_type_currency, ['class'=>'form-control required', 'placeholder'=>'Amount', 'autocomplete' => 'off','value'=>$req->req_type_currency,'readonly'])}}
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Blockchain URL <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::text('blockchain_url', null, ['class'=>'form-control', 'placeholder'=>'Blockchain URL', 'autocomplete' => 'off','onKeyUp'=>'changeblog(this.value)'])}}
                        </div>
                    </div>  
            ...
            <div class="transfer-fund-pop">
                ...
                <div class="filed-box">
                    <div class="form-control-new w100">
                        <label>Amount</label>
                        <input type="text" value="{!! $req->req_type_currency.' '.$req->amount !!}"  id="recipAmt" placeholder="" disabled>
                    </div>
                    <div class="form-control-new w100">
