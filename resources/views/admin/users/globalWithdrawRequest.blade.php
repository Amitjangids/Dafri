...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Global / 3rd Party Pay Withdraw Request</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li class="active"> Global / 3rd Party Pay Withdraw Request</li>
        </ol>
    </section>
        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    <span class="hints">  Search by Name / Email Address / Account Number</span>
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/users/manual-withdraw-request')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
            ...
            <div class="m_content" id="listID">
                @include('elements.admin.users.requestGlobalWithdraw')
            </div>
        </div>
    </section>
</div>
