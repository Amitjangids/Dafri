        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Account Balance <span class="require">*</span>  {{$recordInfo->currency}}</label>
                        <div class="col-sm-10">
                            {{Form::text('wallet_amount', null, ['id'=>'wallet_amount','class'=>'form-control required', 'placeholder'=>'Wallet Balance', 'autocomplete' => 'off', 'disabled' => 'true'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Amount <span class="require">*</span>  {{$recordInfo->currency}}</label>
                        <div class="col-sm-10">
            ...
            <div class="modal-dialog md1">
                <div class="modal-content transfer-pop">
                    <div class="transfer-fund-pop">
                        ...
                        <div class="filed-box">
                            <div class="form-control-new">
                                <label>Account Balance ({{$recordInfo->currency}}) </label>
                        ...
                        <div class="filed-box">
                            <div class="form-control-new">
                                <label>Amount ({{$recordInfo->currency}}) </label>
