...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Crypto Currency For Deposit</h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::to('admin/admins/dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="{{URL::to('admin/merchants')}}"><i class="fa fa-user"></i> <span>Manage Crypto Currency For Deposit</span></a></li>
            <li class="active"> Add Crypto Currency For Deposit</li>
        </ol>
    </section>
        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Deposit Address <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::text('address', null, ['class'=>'form-control required', 'placeholder'=>'Enter Deposit Address', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
