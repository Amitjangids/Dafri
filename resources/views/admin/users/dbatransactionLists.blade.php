        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
               ...
               <div class="form-group align_box dtpickr_inputs">
                   {{-- <span class="hints">Search by Sender Name or Receiver Name</span>
					...
					<div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/users/transaction-list/'.$slug)}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
            ...
            <div class="m_content" id="listID">
                @include('elements.admin.users.dbatransactionLists')
            </div>
        </div>
    </section>
</div>
