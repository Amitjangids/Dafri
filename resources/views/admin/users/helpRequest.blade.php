...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Help Request</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/users/help-request')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
            ...
            <div class="m_content" id="listID">
                @include('elements.admin.users.helpRequest')
            </div>
        </div>
    </section>
</div>
