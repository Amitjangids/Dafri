...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-info">
            ...
            {{Form::model($admin, ['method' => 'post', 'id' => 'adminForm', 'enctype' => "multipart/form-data"]) }}
            <div class="form-horizontal">
                <div class="box-body">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('first_name', null, ['class'=>'form-control required', 'placeholder'=>'Name', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('last_name', null, ['class'=>'form-control required', 'placeholder'=>'Surname', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::password('pass', ['class'=>'form-control', 'placeholder'=>'Password', 'autocomplete' => 'off','id'=>'password', 'minlength' => 8])}}
                        </div>
                    </div> 
