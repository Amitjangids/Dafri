...
<tr>
   ...
   <h1 style="font-size: 25px; margin-bottom: 0; font-weight: 500;">Hello <br>{{$receiverAccEmail}},</h1>
        <p style="padding:3px 0px; font-size:14px;display: block; text-align: center; color:#727379; line-height: 20px">DafriBank Digital is happy to confirm that the following payment was sent to you by {{strtoupper($userName)}}.<br>Please open your own free <a href="<?php echo HTTP_PATH; ?>/choose-account">DafriBank Account</a> to accept this funds.</p>
    </td>
    <td align="center" style="display: block; width: 100%; padding-bottom: 36px;"><span  style="display: inline-block; font-size: 33px;border-radius: 20px;padding: 15px 39px; font-weight: 700; color: #fff; background: #000;box-shadow: 8px 8px 0 rgba(0,0,0,0.1);"> {{$mail_amount}}</span></td>
</tr>
<tr>
